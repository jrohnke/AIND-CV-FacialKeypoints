...
In this project I put together an end-to-end facial feature detection pipeline. I am using OpenCV to detect faces in an image or video. The found faces are passed to a trained CNN to detect facial features.
